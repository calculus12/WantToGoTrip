    ...
    public class MaterialUI : ShaderGUI
    {
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            advancedShadingContent = new GUIContent("Advanced",
                ...
                "• Objects in front of water aren't refracted\n" +
        ...
        private void DrawReflections()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(reflectionSection.anim.faded))
            {
                ...
                if (enableLightReflection)
                {
                    ...
                    UI.Material.DrawSlider(_SunReflectionDistortion, tooltip:"Note: Distortion is largely influenced by the strength of the normal map texture and wave curvature");
                ...
                if (enableEnvReflections)
                {
                    ...
                    UI.Material.DrawSlider(_ReflectionLighting, tooltip:"Technically, lighting shouldn't be applied to the reflected image. If reflections aren't updated in realtime, but lighting is, this is still beneficial.\n\nThis controls how much lighting affects the reflection");
